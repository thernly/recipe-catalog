...
def upgrade() -> None:
    ...
    op.add_column('user_preferences', sa.Column('custom_cuisines', sa.JSON(), nullable=False, server_default='[]'))
    op.add_column('user_preferences', sa.Column('custom_categories', sa.JSON(), nullable=False, server_default='[]'))
